...
for split in splits:
    ...
    anno_files = glob.glob('/home/c3-0/tu666280/NPS/annotations/NPS-Drones-Dataset-Original/*') #Clip_001.txt
    ...
    output_annos_folder = '/home/tu666280/NPSvisdroneStyle/' + split + '/annotations_original'
